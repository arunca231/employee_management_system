...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('theme/assets/plugins/chartist/dist/chartist.min.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="{{route('admin.employ_list')}}">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                            Website
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('admin.employ_list')}}" aria-expanded="false"><i class="me-3 fa fa-user"
    ...
    <script src="{{ asset('theme/assets/plugins/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
